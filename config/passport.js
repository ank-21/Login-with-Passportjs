...
module.exports = function(passport) {
    ...
    //here we making a cookie and encoding and decoding it via serialize and deserialize it. we will give an unique identifier i.e. id of mongodb
